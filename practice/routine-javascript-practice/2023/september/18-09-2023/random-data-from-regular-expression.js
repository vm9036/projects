function generateRandomRegExp() {
  ...
  let results = Number(document.getElementById("results").value);
  if (!results) {
    this.output.showNegativeBadge(
      "Can't generate.",
      '"' + results + '" is not a valid number for number of results.'
    );
    return "";
  }
  console.dir(regex);
  ...
  console.log(answer);
  document.getElementById("generatedRandomRegExpTextArea").value = answer;
}
    ...
    })(
      {
        1: [
          function (e, t, n) {
            function r(e) {
              return (
                e + (97 <= e && e <= 122 ? -32 : 65 <= e && e <= 90 ? 32 : 0)
              );
            }
            function o() {
            ...
            function i(e, t) {
              "number" == typeof t.max && (e.max = t.max),
                t.defaultRange instanceof h &&
                  (e.defaultRange = t.defaultRange),
              ...
              switch (e.type) {
                ...
                case l.GROUP:
                  ...
                  for (
                    e.remember &&
                      ...
                      i = "",
                      h = 0,
                      c = (n = e.options ? a.call(this, e.options) : e.stack)
                        .length;
                    h < c;
                    h++
                  )
                ...
                case l.REPETITION:
                  for (
                    ...
                    i += u.call(this, e.value, t);
                  return i;
                case l.REFERENCE:
                  return t[e.value - 1] || "";
                case l.CHAR:
                  var g =
                    this.ignoreCase && o.call(this) ? r(e.value) : e.value;
          ...
          function (e, t, n) {
            ...
            (r.prototype.overlaps = function (e) {
              ...
              (r.prototype.add = function (e) {
                return (
                  this.touches(e) &&
                  new r(Math.min(this.low, e.low), Math.max(this.high, e.high))
                );
              }),
              ...
              (o.prototype.add = function (e, t) {
                function n(e) {
                  for (
                    var t = [], n = 0;
                    n < s.ranges.length && !e.touches(s.ranges[n]);

                  )
                    t.push(s.ranges[n].clone()), n++;
                  for (; n < s.ranges.length && e.touches(s.ranges[n]); )
                    (e = e.add(s.ranges[n])), n++;
                  for (t.push(e); n < s.ranges.length; )
                    t.push(s.ranges[n].clone()), n++;
                  (s.ranges = t), a(s);
                }
                var s = this;
              ...
              (o.prototype.subtract = function (e, t) {
                function n(e) {
                  for (
                    var t = [], n = 0;
                    n < s.ranges.length && !e.overlaps(s.ranges[n]);

                  )
                    t.push(s.ranges[n].clone()), n++;
                  for (; n < s.ranges.length && e.overlaps(s.ranges[n]); )
                    (t = t.concat(s.ranges[n].subtract(e))), n++;
                  for (; n < s.ranges.length; )
                    t.push(s.ranges[n].clone()), n++;
                  (s.ranges = t), a(s);
                }
                var s = this;
            ...
            (t.exports = function (e) {
              ...
              for (t = f.length; i < t; )
                switch ((n = f[i++])) {
                  ...
                  case ")":
                    0 === l.length &&
                      r.error(e, "Unmatched ) at column " + (i - 1)),
                      (h = (p = l.pop()).options
                  ...
                  case "{":
                    var R,
                      C,
                      w = /^(\d+)(,(\d+)?)?\}/.exec(f.slice(i));
                    null !== w
                      ? (0 === h.length && c(i),
                        (R = parseInt(w[1], 10)),
                        (C = w[2] ? (w[3] ? parseInt(w[3], 10) : 1 / 0) : R),
                        (i += w[0].length),
                        h.push({
                          type: o.REPETITION,
                          min: R,
...
function copyGeneratedRandomRegExp() {
  copyToClipboard(
    document.getElementById("generatedRandomRegExpTextArea").value
  );
  document.getElementById("generatedRandomRegExpTextArea").select();
}
